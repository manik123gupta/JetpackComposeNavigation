...
fun LearnConstraintLayout() {
    ConstraintLayout {
        ...
        Button(
            onClick = {}, colors = ButtonDefaults.buttonColors(Color.Red), modifier = Modifier
        ...
        Button(
            onClick = {}, colors = ButtonDefaults.buttonColors(Color.Green), modifier = Modifier
        ...
        Button(
            onClick = {}, colors = ButtonDefaults.buttonColors(Color.Blue), modifier = Modifier
        ...
        Button(
            onClick = {}, colors = ButtonDefaults.buttonColors(Color.Yellow), modifier = Modifier
